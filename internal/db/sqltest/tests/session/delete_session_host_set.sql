begin;
  ...
  select is(count(*), 4::bigint) from session_host_set where host_set_id = 's___1cb-sths';
  ...
  select is(count(*), 0::bigint) from session_host_set where host_set_id = 's___1cb-sths';
