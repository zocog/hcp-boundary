...
begin;
  ...
  values
    ('s1____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s1____walter', 'h_____wb__01');
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s2____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s2____walter', 'h_____wb__01');
  insert into session_credential_dynamic
    ( session_id,    library_id,     credential_id,  credential_purpose)
  values
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s3____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s3____walter', 'h_____wb__01');
  insert into session_credential_dynamic
    ( session_id,    library_id,     credential_id,  credential_purpose)
  values
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s4____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s4____walter', 'h_____wb__01');
  insert into session_credential_dynamic
    ( session_id,     library_id,     credential_id,  credential_purpose)
  values
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s5____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s5____walter', 'h_____wb__01');
  insert into session_credential_dynamic
    ( session_id,     library_id,     credential_id,  credential_purpose)
  values
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s6____walter', 's___1wb-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s6____walter', 'h_____wb__01');
  select is(count(*),             4::bigint)        from wh_credential_dimension                 where organization_id = 'o_____widget';
  ...
  insert into session_host_set
    (public_id, host_set_id)
  values
    ('s7____walter', 's___1ws-sths');
  insert into session_host
    (public_id, host_id)
  values
    ('s7____walter', 'h_____ws__01');
  select is(count(*),             4::bigint)        from wh_credential_dimension                 where organization_id = 'o_____widget';
